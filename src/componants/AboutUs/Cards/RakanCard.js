        ...
        <div className="card">
          ...
          <div className="card__content">
            <div className="contact-card">
              <div>
                <h3 className="card__title">Rakan Al-Madani</h3>
                <p>hi there my name is Rakan and i am a great gamer and my dream is to be a great devoloper</p>
              </div>
              <div>
